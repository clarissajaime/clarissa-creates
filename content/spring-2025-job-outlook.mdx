...
![layoff chart](/blog/layoffs.jpeg)

- **Overall job openings have significantly dropped**—current software developer postings are about one-third lower than their pre-pandemic levels.
